...
class UNet2d(nn.Module):
    def __init__(self, in_chl=1, out_chl=1, model_chl=64): #64
        ...
        self.end = nn.Sequential(ConvBnRelu2d(self.model_chl, 1, kernel_size=1, stride=1, padding=0, is_bn=False, is_relu=False))
